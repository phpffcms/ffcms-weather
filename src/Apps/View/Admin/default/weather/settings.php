...
<?= $form->field('mapKey', 'text', ['class' => 'form-control'], __('Set your map api key from mapbox.com. Example: pk.eyJ1Ija1esVubqIsImEiOiJjaXo4bGJlNTQwMDIwMzJvZjBrZnRla29vIn0.6juuODrmHHHwJrjCC1qpbQ')) ?>
